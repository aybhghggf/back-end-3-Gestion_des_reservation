...
<body class="bg-white text-gray-900">
    ...
    <body class="bg-[#F9FAFB] text-gray-900">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="bg-white rounded-lg shadow-sm overflow-hidden relative">
                    <img alt="Computer monitor showing code editor with JavaScript code"
                        ...
                        src="https://storage.googleapis.com/a1aa/image/8b367adc-6f61-47c9-280e-6baa1ddcfdd9.jpg"
                        width="600" />
                    <div
                        class="absolute top-3 right-3 bg-[#1E40AF] text-white text-xs font-semibold rounded-full px-3 py-1">
                        Bestseller
                    </div>
                    <div class="p-4">
                        <span
                            class="inline-block bg-[#DBEAFE] text-[#1E40AF] text-xs font-semibold rounded px-2 py-0.5 mb-2">
                            Programming
                        </span>
                        ...
                        <p class="text-gray-600 text-sm leading-snug">
                            Learn modern web development with JavaScript,
                        </p>
                    </div>
                </div>
        ...
        <section class="py-16 px-4 max-w-7xl mx-auto bg-[#f7f9fc]">
            <div class="text-center max-w-xl mx-auto mb-12">
              <h2 class="font-extrabold text-lg md:text-xl text-slate-900 mb-2">How It Works</h2>
              <p class="text-sm md:text-base text-slate-600">
                Our platform makes it easy to find, book, and attend the courses you need to achieve your goals.
              </p>
            </div>
            <div class="flex flex-col sm:flex-row justify-between gap-10 max-w-5xl mx-auto">
              <div class="flex flex-col items-center text-center max-w-xs mx-auto">
                <div class="bg-blue-200 rounded-full w-16 h-16 flex items-center justify-center mb-4">
                  <i class="fas fa-search text-blue-900 text-xl"></i>
                </div>
                <h3 class="font-bold text-sm md:text-base mb-2">1. Find Your Course</h3>
                <p class="text-xs md:text-sm text-slate-600">
                  Browse our extensive catalog of courses or use our search and filter tools to find exactly what you're looking for.
                </p>
              </div>
              <div class="flex flex-col items-center text-center max-w-xs mx-auto">
                <div class="bg-blue-200 rounded-full w-16 h-16 flex items-center justify-center mb-4">
                  <i class="far fa-calendar-check text-blue-900 text-xl"></i>
                </div>
                <h3 class="font-bold text-sm md:text-base mb-2">2. Book Your Spot</h3>
                <p class="text-xs md:text-sm text-slate-600">
                  Reserve your place in the course with our simple booking system. Secure payment options available.
                </p>
              </div>
              <div class="flex flex-col items-center text-center max-w-xs mx-auto">
                <div class="bg-blue-200 rounded-full w-16 h-16 flex items-center justify-center mb-4">
                ...
                <h3 class="font-bold text-sm md:text-base mb-2">3. Start Learning</h3>
                <p class="text-xs md:text-sm text-slate-600">
                  Access your course materials, attend live sessions, and track your progress through your personal dashboard.
                </p>
              </div>
            </div>
          </section>

          <section class="bg-[#1a2a7a] text-white text-center px-4 py-12 sm:py-16 md:py-20">
            <h2 class="font-semibold text-lg sm:text-xl md:text-2xl max-w-3xl mx-auto">
              Ready to Start Your Learning Journey?
            </h2>
            <p class="mt-3 text-sm sm:text-base max-w-xl mx-auto">
              Join thousands of students who are already advancing their careers with our expert-led courses.
            </p>
            <div class="mt-6 flex justify-center gap-4 flex-wrap">
              <button
                class="bg-white text-[#1a2a7a] font-semibold rounded-md px-5 py-2 text-sm sm:text-base hover:bg-gray-100 transition"
              >
                Get Started Today
              </button>
              <button
                class="border border-white font-semibold rounded-md px-5 py-2 text-sm sm:text-base hover:bg-white hover:text-[#1a2a7a] transition"
              >
                Browse Courses
              </button>
            </div>
